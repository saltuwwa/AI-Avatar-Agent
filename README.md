...
- [x] **Скриншоты / GIF** — добавьте файлы и перечислите в разделе ниже.  
- [x] **Стоимость API** — заполните приблизительные суммы OpenAI / fal.  
...
сначала отладите MCP, LLM, ASR, TTS; **Creatify Aurora** тратит баланс fal — включайте генерацию видео, когда остальное стабильно. Держите ответы агента **короче (ориентир 15–30 с речи)** — длина видео следует за аудио.
